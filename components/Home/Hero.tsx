      ...
      <div className="grid grid-cols-1 items-center justify-center w-full lg:container px-3 pt-36 pb-20 gap-10">
        <SwipeUpOnScroll>
          <div className="flex flex-col items-center justify-center w-full gap-4 max-w-2xl mx-auto">
            <p className="text-md font-normal px-4 py-0.5 rounded-full border border-indigo-500 dark:border-indigo-500 bg-indigo-500/20 flex items-center gap-2">
        ...
        <SwipeUpOnScroll>
          <div className="backdrop-blur-sm rounded-2xl border border-neutral-200 dark:border-neutral-700/50 p-6 max-w-5xl w-full mx-auto">
            <div className="grid lg:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="bg-neutral-100 dark:bg-neutral-800 rounded-lg p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="h-2 bg-gradient-to-r from-indigo-500 to-pink-500 opacity-30 rounded w-2/3"></div>
                ...
                <div className="bg-neutral-100 dark:bg-neutral-800 rounded-lg p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="h-2 bg-gradient-to-r from-indigo-500 to-pink-500 opacity-30 rounded w-3/5"></div>
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-br from-indigo-500/10 via-pink-500/5 to-rose-500/10 rounded-lg p-4 border border-indigo-500/20">
                  <div className="flex items-center space-x-2 mb-3">
                  ...
                  <div className="bg-white dark:bg-neutral-800 rounded-lg p-4 text-xs border border-neutral-200 dark:border-neutral-700">
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        <div className="h-2 bg-gradient-to-r from-indigo-500 to-pink-500 rounded w-1/4"></div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div className="bg-neutral-100 dark:bg-neutral-800 rounded-lg p-3 text-center">
                    <div className="bg-gradient-to-r from-indigo-500 to-pink-500 bg-clip-text text-transparent font-bold text-lg">
                      98%
                    </div>
